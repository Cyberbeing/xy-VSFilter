...
extern IPin* AppendFilter(IPin* pPin, const CString& DisplayName, IGraphBuilder* pGB);
extern IPin* InsertFilter(IPin* pPin, const CString& DisplayName, IGraphBuilder* pGB);
...
extern void ShowPPage(const CString& DisplayName, HWND hParentWnd);
...
extern bool GetKeyFrames(const CString& fn, CUIntArray& kfs);
...
extern bool CreateFilter(const CStringW& DisplayName, IBaseFilter** ppBF, CStringW& FriendlyName);
extern IBaseFilter* AppendFilter(IPin* pPin, IMoniker* pMoniker, IGraphBuilder* pGB);
extern CStringW GetFriendlyName(const CStringW& DisplayName);
...
extern GUID GUIDFromCString(const CString& str);
extern HRESULT GUIDFromCString(const CString& str, GUID& guid);
...
extern void		HexDump(const CString& fName, BYTE* buf, int size);

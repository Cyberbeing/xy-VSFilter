...
typedef ::boost::shared_ptr<CWordPaintResultKey> SharedPtrCWordPaintResultKey;
...
public:
    ...
    const SharedPtrCWordPaintResultKey& GetHashKey();
private:
    CWordPaintMachine(){}
    ...
    SharedPtrCWordPaintResultKey m_key;
};
